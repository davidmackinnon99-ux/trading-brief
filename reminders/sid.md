<!-- SID reminders — ONE PER LINE. Each non-comment line prints as its own reminder in the SID section.
...
DO NOT trade with 2 days of RSI reversals
After an Earnings make sure you start the OB/OS cycle again, except MAYBE if it was a day or so before.