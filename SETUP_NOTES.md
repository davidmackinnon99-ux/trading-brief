...
**Paths touched:**
- `~/Trading Indicators/` (plain Finder folder — deliberately kept out of iCloud/Google Drive sync; previously named ~/Indicators, renamed 16 Sep 2026)
...
risky for the Trading Indicators repo, which also holds files pulled from the web.
...
Note: some "Operation not permitted" failures are a sync layer (Drive/iCloud) locking a file
